...
class FieldAuditSurveyDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'admin.quality-assurance-surveys.field-audit.actions');
    }
    ...
    {
        $query = $model->where('type','Field Audit')->orderBy('created_at' , 'DESC')->newQuery();
    ...
    {
        return $this->builder()
                    ->setTableId('fieldauditsurveydatatable-table')
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('treatement_date'),
            Column::make('treatement_date')->hidden(),
    ...
    {
        return 'FieldAuditSurvey_' . date('YmdHis');
    }
}
