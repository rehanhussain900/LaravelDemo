    ...
    <div class="content-wrapper">
        ...
        <div class="content-body">
                ...
                <div class="auth-inner row m-0">
                    ...
                    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            ...
                            <p class="card-text mb-2 mt-5">Make your app management easy and fun!</p>
                            @if ($errors->any())
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-merge form-password-toggle @error('password_confirmation') is-invalid @enderror">
                                        <input class="form-control form-control-merge @error('password_confirmation') is-invalid @enderror"
                                               ...
                                               aria-describedby="password_confirmation" tabindex="2" required autofocus
           ...
           'privacy_policy' => '<a target="_blank" href="'.route('policy.show').'" class="underline text-sm text-gray-600 hover:text-gray-900">'.__('Privacy Policy').'</a>',
                            ...
                            <p class="text-center mt-2">{{__('Already have an account?')}}
