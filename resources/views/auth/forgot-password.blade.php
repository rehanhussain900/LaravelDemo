                ...
                <div class="auth-inner row m-0">
                    ...
                    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            ...
                            <p class="card-text mb-2 mt-5">Enter your email and we'll send you instructions to reset
                                your password</p>
                            @if ($errors->any())
                            ...
                            <p class="text-center mt-2"><a
                                        href="{{ route('login') }}"><span><i data-feather='arrow-left'></i> {{__('Back to login')}}</span></a>
                            </p>
                        </div>
                    </div>
                    <!-- /Login-->
