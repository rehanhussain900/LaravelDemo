        ...
        <div class="row">
            <div class="form-group col-md-3">
                ...
                <input type="text" name="name" id="name" class="form-control"
                       placeholder="Name"
                       value="{{$selected['customer_info']['name']??''}}"
                       required/>
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" name="business_name" id="business_name" class="form-control"
                       ...
                       value="{{$selected['customer_info']['business_name']??''}}"
                />
            </div>
            <div class="form-group col-md-6">
                ...
                <input type="text" name="billing_name" id="billing_name" class="form-control"
                       ...
                       value="{{$selected['customer_info']['billing_name']??''}}"
                       required/>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <input type="text" name="service_address" id="service_address" class="form-control"
                       ...
                       value="{{$selected['customer_info']['service_address']??''}}"
                       required/>
            </div>
            <div class="form-group col-md-6">
                ...
                <input type="text" name="billing_address" id="billing_address" class="form-control"
                       ...
                       value="{{$selected['customer_info']['billing_address']??''}}"
                       required/>
        ...
        <div class="row">
            <div class="form-group col-md-2">
                ...
                <input type="text" name="service_city" id="service_city" class="form-control"
                       ...
                       value="{{$selected['customer_info']['service_city']??''}}"
                       required/>
            </div>
            <div class="form-group col-md-2">
                ...
                <select name="service_state_id" id="service_state" class="form-control" required>
                    @if(!empty($selected['customer_info']['service_state_id']->name))
                        <option value="{{$selected['customer_info']['service_state_id']->id}}" selected>
                            {{$selected['customer_info']['service_state_id']->name}}
                        </option>
                    @endif
                </select>
            </div>
            <div class="form-group col-md-2">
                ...
                <input type="text" name="service_zip" id="service_zip" class="form-control"
                       ...
                       value="{{$selected['customer_info']['service_zip']??''}}"
                       required/>
            </div>
            <div class="form-group col-md-2">
                ...
                <input type="text" name="billing_city" id="billing_city" class="form-control"
                       ...
                       value="{{$selected['customer_info']['billing_city']??''}}"
                       required/>
            </div>
            <div class="form-group col-md-2">
                ...
                <select name="billing_state_id" id="billing_state" class="form-control" required>
                    @if(!empty($selected['customer_info']['billing_state_id']->name))
                        <option selected
                                value="{{$selected['customer_info']['billing_state_id']->id}}">{{$selected['customer_info']['billing_state_id']->name}}</option>
                    @endif
                </select>
            </div>
            <div class="form-group col-md-2">
                ...
                <input type="text" name="billing_zip" id="billing_zip" class="form-control"
                       ...
                       value="{{$selected['customer_info']['billing_zip']??''}}"
                       required/>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <input type="text" name="phone_1" id="phone_home" class="form-control"
                       placeholder="Phone #1"
                       value="{{$selected['customer_info']['phone_1']??''}}"
                       required/>
            </div>
            <div class="form-group col-md-6">
                ...
                <input type="text" name="phone_2" id="phone_cell" class="form-control"
                       placeholder="Phone #2"
                       value="{{$selected['customer_info']['phone_2']??''}}"
                       required/>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <input type="text" name="attention_line" id="attention-line" class="form-control"
                       ...
                       value="{{$selected['customer_info']['attention_line']??''}}"
                       required/>
            </div>
            <div class="form-group col-md-6">
                ...
                <input type="email" name="email" id="email" class="form-control"
                       ...
                       value="{{$selected['customer_info']['email']??''}}"
                       required/>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-4 account-number-wrap" id="account-number-wrap">
                ...
                <input type="number" name="account_number" id="account-number" class="form-control"
                       ...
                       value="{{$selected['customer_info']['account_number']??''}}"/>
            </div>
            <div class="form-group col-md-4">
                ...
                <input type="text" name="proposed_by" id="proposed-by" class="form-control"
                       ...
                       value="{{$selected['customer_info']['proposed_by']??\Auth::user()->email}}"
                       required/>
            </div>
            <div class="form-group col-md-4">
                ...
                <input type="text" name="contract_date" id="contract-date" class="form-control date-picker"
                       ...
                       value="{{$selected['customer_info']['contract_date']??\Carbon\Carbon::make('now')->format('Y-m-d')}}"
                       required/>
            </div>
        </div>
    </form>
