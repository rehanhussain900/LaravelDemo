...
@section('title','Quality Assurance Surveys | Sentricon Audit')
@section('heading','Quality Assurance Surveys | Sentricon Audit')
@section('breadcrumb')
    <li class="breadcrumb-item active">Quality Assurance Surveys | Sentricon Audit</li>
@endsection
@section('buttons')
    {{--@can('add contract')
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body" id="sentricon-body">
                        @include("admin.quality-assurance-surveys.sentricon-audit.overview")
                    </div>
                </div>
            </div>
        </div>
...
@push('footer')
    ...
    <script>
      ...
      $(document).ready(function () {
        window.LaravelDataTables['sentriconauditsurveydatatable-table'].on('draw', function () {
          $(document).trigger('refresh.icons')
          columnToggleButton(window.LaravelDataTables['sentriconauditsurveydatatable-table'])
        })
      });
