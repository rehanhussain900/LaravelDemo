    ...
    <div class="row invoice-preview">
        ...
        <div class="col-xl-10 col-md-10 col-12">
            <div class="card invoice-preview-card">
                <div class="card-body invoice-padding pb-0">
                    ...
                    <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                        ...
                        <div class="mt-md-0 mt-2">
                            ...
                            <p class="card-text mb-25"><b>Treatment Date: </b>{{$survey->treatement_date}} </p>
                    ...
                    <div class="row invoice-sales-total-wrapper">
                        <div class="col-md-12 d-flex justify-content-end order-md-2 order-1">
                            <div class="invoice-total-wrapper">
                                <div class="invoice-total-item pull-right">
                                    <p class="invoice-total-title">Service Duration Time : {{$survey->survey_date}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <hr class="invoice-spacing" />
                 <!-- Signature and score -->
                <div class="card-body invoice-padding pt-5">
                    <div class="row invoice-spacing">
                        <div class="col-md-2"> {{$survey->auditor_signature ?? 'N/A' }} <hr class="" /></div>
                        <div class="col-md-2">{{$survey->technician_signature ?? 'N/A'}} <hr class="" /></div>
                        <div class="col-md-2">{{$survey->interview_score ?? 'N/A'}} <hr class="" /></div>
                        <div class="col-md-2">{{$survey->inspection_score ?? 'N/A'}} <hr class="" /></div>
                        <div class="col-md-2">{{$survey->average_score ?? 'N/A'}} <hr class="" /></div>
                        <div class="col-md-2">{{$survey->is_follow_up == 1 ? 'Yes' : 'No'}} <hr class="" /></div>
                    </div>
                    <div class="row invoice-spacing">
                        <div class="col-md-2">Auditor Signature</div>
                        <div class="col-md-2">Technician Signature</div>
                        <div class="col-md-2">Interview Score</div>
                        <div class="col-md-2">Inspection Score</div>
                        <div class="col-md-2">Average Score</div>
                        <div class="col-md-2">Follow-up Required</div>
                    </div>
                </div>
                <!--  Signature and score  -->
        ...
        <div class="col-xl-2 col-md-2 col-12 invoice-actions mt-md-0 mt-2">
            <div class="card">
                <div class="card-body">
                    @can('access qas')
                        <a class="btn btn-outline-secondary btn-block mb-75" href="{{Route('admin.qas.download' , $survey->id)}}" target="_blank" title="Download Signed Document"> <i data-feather='download'></i> </a>
                    @endcan
                </div>
            </div>
        </div>
