            ...
            <div class="row invoice-preview">
                ...
                <div class="col-12">
                    <div class="card invoice-preview-card">
                        ...
                        Service Duration Time : {{$survey->survey_date}}
                        ...
                        <div >
                            <table >
                                ...
                                <tr>
                                    <td>&nbsp;<hr class="" /></td>
                                    <td>&nbsp;<hr class="" /></td>
                                    <td>{{$survey->interview_score ?? 'N/A'}} <hr class="" /></td>
                                    <td>{{$survey->inspection_score ?? 'N/A'}} <hr class="" /></td>
                                    <td>{{$survey->average_score ?? 'N/A'}} <hr class="" /></td>
                            ...
                            <tr>
                                <td style="width: 500px;">
                                    <span class="font-weight-bold">List : </span>
                                        <span><u>{{$survey->pests_list}}</u></span> 
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 500px;">
                                    ...
                                    <span class="font-weight-bold">We will have our office contact you to schedule a follow-up treatment.
                                        Areas conducive for pest activity : </span> <u>{{$survey->pest_activity_areas}}	</u>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 500px;">
